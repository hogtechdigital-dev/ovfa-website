...
export default function EventsPage() {
  return (
    <>
      ...
      <section className="py-20 px-4 sm:px-8 md:px-12 lg:px-20" style={{ background: "linear-gradient(160deg, #F8F4EE 0%, #EFE9DC 100%)" }}>
        <div style={{ maxWidth: 1152, margin: "0 auto" }}>
          <div className="text-center mb-14 reveal">
            <p className="text-crimson text-xs tracking-widest uppercase font-sans mb-3">Join the Move</p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
            {events.map((e) => (
              <div key={e.id} className={`bg-cream-light border-t-4 ${e.color} rounded-2xl p-7 card-hover reveal`} style={{ boxShadow: "0 4px 20px rgba(23,61,26,0.08)" }}>
                ...
                <p className="text-gray-700 font-sans text-sm leading-loose mb-5">{e.description}</p>
      ...
      <section className="py-20 px-4 sm:px-8 md:px-12 lg:px-20" style={{ background: "linear-gradient(135deg, var(--forest) 0%, var(--forest3) 100%)" }}>
